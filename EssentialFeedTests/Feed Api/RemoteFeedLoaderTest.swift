...
class RemoteFeedLoaderTest: XCTestCase {
    ...
    func test_load_deliverNoItemsOn200HTTPResponseWIthJSONEmptyList() {
        let (sut, client) = makeSUT()
    ...
    func test_load_deliverItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = makeItem(
            id: UUID(),
            imageURL: URL(string: "http;//a-given-url.com")!)

        let item2 = makeItem(
            id: UUID(),
            description: "a description",
            location: "a location",
            imageURL: URL(string: "http;//another-given-url.com")!)
    ...
    func test_load_doesNotDeliverResultAfterSUTInstanceHasDeallocated() {
